     ...
     <div class="deal-data">
      <dl>
       ...
       <span class="deal-balance">收益状态</span>
		  ...
		  <c:forEach items="${paginationVO.list}" var="incomeRecord" varStatus="status">
			  <dd>
                  ...
                  <c:choose>
                      <c:when test="${incomeRecord.incomeStatus==1}">
                          <div class="deal-balance">已返还</div>
                      </c:when>
                      <c:otherwise>
                          <div class="deal-balance">未返还</div>
                      </c:otherwise>
                  </c:choose>
