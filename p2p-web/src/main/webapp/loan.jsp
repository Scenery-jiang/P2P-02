...
<div id="loanList">
    <div class="mainBox pro-list-body clearfix" id="rollingLayer">
        <div class="pro-list <c:if test="${productType eq 2}">disperse-pro</c:if>">
            <c:forEach items="${paginationVO.list}" var="loanInfo">
                <!--已满标时追加pro-full-->
                ...
                <tr>
                    <td>
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                <a id="lnkNext" href="loan/loan?ptype=${product_type}">首页</a>
                                <a id="lnkNext"
                                   href="loan/loan?ptype=${product_type}&currentPage=${currentPage-1}">上一页</a>
                            </c:otherwise>
                        </c:choose>
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                <a id="lnkNext"
                                   href="loan/loan?ptype=${product_type}&currentPage=${currentPage+1}">下一页 </a>
                                <a id="lnkNext"
                                   href="loan/loan?ptype=${product_type}&currentPage=${totalPage}">尾页</a>
                            </c:otherwise>
                        </c:choose>
                    </td>
                </tr>
