        ...
        <div class="allInvest clearfix">
            <div class="eachInvest invest-tab">
                ...
                <div class="invest-tab-box">
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                <c:forEach items="${bidInfoList}" var="bidInfo" varStatus="status">
                                    <dd>
                                        <span class="name">${status.count}</span>
                    ...
                    <%-- <c:choose>
                         <c:when test="${bidInfoList.size()>5}">
            ...
            <div class="eachInvest invest-tab invest-tab-box">
                ...
                <dl>
                    ...
                    <c:choose>
                        <c:when test="${empty rechargeRecordList}">
                            还没有充值记录哦!
                        </c:when>
                        <c:otherwise>
                            <c:forEach items="${rechargeRecordList}" var="rechargeRecord" varStatus="status">
                                <dd>
                                    <span class="name">${status.count}</span>
                                    <span id="preparedLoanStandardTotalLoanCount"
                                          class="number">${rechargeRecord.rechargeDesc}</span>
                                    <span id="preparedLoanStandardTotalBidMoney"
                                          class="money">${rechargeRecord.rechargeMoney}</span>
                                    <span id="preparedLoanStandardTotalIncome" class="profit"><fmt:formatDate
                                            value="${rechargeRecord.rechargeTime}"
            ...
            <div class="eachInvest recent-earnings">
                ...
                <dl id="recentearning">
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <c:forEach items="${incomeRecordList}" var="incomeRecord" varStatus="status">
                                <dd>
                                    <span class="number" style="text-align:left;">1</span>
                                    <span id="preparedLoanStandardTotalLoanCount"
                                          class="number">${incomeRecord.loanInfo.productName}</span>
                                    <span id="preparedLoanStandardTotalIncome" class="number name"
                                          style="text-align:center;"><fmt:formatDate value="${incomeRecord.incomeDate}"
                                                                                     pattern="yyyy-MM-dd HH:mm:ss"/> </span>
                                    <span id="preparedLoanStandardTotalBidMoney"
                                          class="profit">${incomeRecord.incomeMoney}</span>
